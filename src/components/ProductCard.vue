<template>
  <div class="product">
    <div>
      <img class="img-product" v-if="url" v-bind:src="url" />
      <img class="img-product" v-if="!url" v-bind:src="image" />
    </div>
...
export default {
  ...
  data() {
    return {
      cartQuantity: 0,
      image:
        "https://image.made-in-china.com/202f0j10SmRaBwqoSbrO/5-2-Inch-CDMA-Smart-Phone-Cheap-Cell-Phone.jpg",
      messageFlag: false,
      messageContent: {},
    };
  },
